...
<div class="bg"><br />
	...
	echo '<div class="row">
			<div class="col-sm-5">
				<label class="sai_head">'.$l['all_notify_update'].'</label>
				<span class="sai_exp">'.$l['all_notify_update_exp'].'</span>
			</div>
			<div class="col-sm-7">
				<input type="checkbox" id="all_notify_update" name="all_notify_update" '.POSTchecked('all_notify_update', (empty($user['disable_all_notify_update']) ? 1 : 0)).' />
			</div>
		</div><br />
