	...
	<div class="bg"><br />
		...
		<div class="row" align="center">
			<div class="col-sm-12 col-xs-12">
				<a href="'.$globals['ind'].'act=software&soft=4" style="text-decoration:none;">
				...
				<a href="'.$globals['ind'].'act=sitepad" class="sitepad-old-but" style="text-decoration:none;">
					'.$l['access_old_editor'].'
				</a>' : '').'
			</div>
		</div>
		...
		foreach($sitepad_plans as $slug => $plan){
			...
			<div class="col-sm-3 pricing_tab" id="'.$slug.'" width="100%">
				<ul>
					...
					<li>'.$l['plan_unlimited'].' Blog Posts</li>';
					...
					echo '<li><a href="'.$globals['ind'].'act=sitepad" target="_blank" class="buy_button">'.$l['get_started_btn'].'</a></li>
				</ul>
			</div>';
		}
		
		echo '<div align="center">* '.$l['expiry_notice'].'</div>
		</div><br />
