	...
	<div class="bg2">
		<div class="row">
			...
			<div class="col-sm-6 col-md-6 col-xs-12" style="padding-bottom:20px;">
				...
				<div id="overview_img" style="padding:10px;"> <img src="'.$globals['mirror_images'].'softimages/screenshots/'.$soft.'_screenshot1.gif" class="img-responsive" alt=""> </div>
