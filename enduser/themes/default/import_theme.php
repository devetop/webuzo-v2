		...
		<form accept-charset="'.$globals['charset'].'" name="importsoftware" method="post" action="" onsubmit="return checkform(this.id);" class="form-horizontal" id="importsoftware">';
			...
			<div class="bg"><br />
				...
				if(empty($softpanel->noprotocol) && empty($globals['hide_protocol'])){
					...
					echo '
					<div class="bg2" id="local_import" '.(isset($_POST['remote_submit']) ? 'style="display:none;"' : '').'>';
						if(empty($globals['off_sync_link']) && !aefer() && !ent()){
							echo '
							<div class="row">
								<div class="col-sm-12" style="text-align:right;">
									<span class="flat-butt"><a href="'.$globals['ind'].'act=sync&manual=1" id="local_all_imp" style="text-decoration:none;color:#fff;">'.$l['local_import'].'</a></span>
								</div>
							</div><br />';
						}
						echo '<div class="row">
