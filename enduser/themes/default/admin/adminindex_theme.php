...
<div class="bg2"><br />';
	...
	<div class="alert alert-danger text-center">
		...
		<a href="https://webuzo.com/blog/eol-webuzo-v2/" target="_blank" style="text-decoration:none">Webuzo <b>v2</b> is now being declared End of Life and we urge everyone to upgrade to <b>v3</b>.</a>&nbsp;
		<a href="https://www.webuzo.com/docs/admin/upgrade-to-webuzo-v3/" target="_blank" style="text-decoration:none">Refer to the upgrade guide here.</a>
	</div>';
	...
	echo '<div class="row">
		...
		<div class="col-sm-8">
			<div class="softinfo" >'.(!defined('SOFTRESELLER') ? '<b>'.$l['soft_license'].'</b> : '.$globals['license'].' ('.$globals['primary_ip'].')<br />
				<b>'.$l['soft_license_type'].'</b> : '.(empty($globals['lictype']) ? $l['type_0'].' <br /><a href="'.serverurls('buy').'" target="_blank"><button class="btn btn-success btn-sm">'.$l['become_premium'].'</button></a>&nbsp; <a href="'.serverurls('pricing').'" target="_blank"><button class="btn btn-warning btn-sm">'.$l['pricing'].'</button></a>' : '<font color="green">'.$l['type_1']).'</font>&nbsp; <a href="'.$globals['ind'].'refreshlicense"><button class="btn btn-primary btn-sm">'.$l['refreshlicense'].'</button></a>'.(asperapp(0, 1, 1) ? '&nbsp; (<a href="'.$globals['ind'].'act=licensekey">Enter License Key</a>)' : '') : '').' <br />
