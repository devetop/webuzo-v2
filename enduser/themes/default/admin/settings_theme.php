...
if(!defined('SOFTRESELLER')){
	...
	<div class="row">
		<div class="col-sm-7">
			<label class="sai_head">'.$l['user_homedir'].'</label><br />
			<span class="sai_exp2">'.$l['user_homedir_exp'].'</span>
		</div>
		<div class="col-sm-5">
			<input type="text" name="user_homedir" class="form-control" size="30" value="'.POSTval('user_homedir', $globals['user_homedir']).'" />
		</div>
	</div><br />
...
echo '<div class="sai_form_head">'.$l['backup_set'].'	</div>
	...
	echo'<div class="row">
		...
		<div class="row">
			<div class="col-sm-7">
				<label class="sai_head">'.$l['max_backups_local'].'</label><br />
				<span class="sai_exp2">'.$l['max_backups_local_exp'].'</span>
			</div>
			<div class="col-sm-5">
				<select name="max_backups_local" class="form-control">';
				for($i=0; $i<=10; $i++){
	...
	echo '<div class="row">
		...
		<div class="row">
			<div class="col-sm-7">
				<label class="sai_head">'.$l['disable_backup'].'</label><br />
				<span class="sai_exp2">'.$l['disable_backup_exp'].'</span>
			</div>
			<div class="col-sm-5">
				<input type="checkbox" name="off_rbackup" '.POSTchecked('off_rbackup', @$globals['off_rbackup']).' /><span class="sai_head">&nbsp;'.$l['off_rbackup'].'</span><br />
				<input type="checkbox" name="disable_backup_ftp" '.POSTchecked('disable_backup_ftp', @$globals['disable_backup_ftp']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_ftp'].'</span><br />
				<input type="checkbox" name="disable_backup_softftpes" '.POSTchecked('disable_backup_softftpes', @$globals['disable_backup_softftpes']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_ftps'].'</span><br />
				<input type="checkbox" name="disable_backup_softsftp" '.POSTchecked('disable_backup_softsftp', @$globals['disable_backup_softsftp']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_sftp'].'</span><br />
				<input type="checkbox" name="disable_backup_dropbox" '.POSTchecked('disable_backup_dropbox', @$globals['disable_backup_dropbox']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_dropbox'].'</span><br />
				<input type="checkbox" name="disable_backup_gdrive" '.POSTchecked('disable_backup_gdrive', @$globals['disable_backup_gdrive']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_gdrive'].'</span><br />
				<input type="checkbox" name="disable_backup_webdav" '.POSTchecked('disable_backup_webdav', @$globals['disable_backup_webdav']).' /><span class="sai_head">&nbsp;'.$l['remote_backup_webdav'].'</span>
			</div>
		</div><br />
		<p><input type="submit" class="flat-butt " name="editsettings" value="'.$l['edit_settings'].'"/></p>
	</div><br />';
...
echo '<div class="row">
	...
	<div class="row">
		<div class="col-sm-7">
			<label class="sai_head">'.$l['eu_default_email_settings'].'</label><br />
			<span class="sai_exp2">'.$l['eu_default_email_settings_exp'].'</span>
		</div>
		<div class="col-sm-5">
			<input type="checkbox" name="eu_off_default_install_notify" '.(isset($_REQUEST['eu_off_default_install_notify']) || empty($globals['eu_off_default_install_notify']) ? 'checked="checked"' : '').'/><span class="sai_head">&nbsp;'.$l['eu_off_default_install_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_remove_notify" '.(isset($_REQUEST['eu_off_default_remove_notify']) || empty($globals['eu_off_default_remove_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_remove_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_edit_notify" '.(isset($_REQUEST['eu_off_default_edit_notify']) || empty($globals['eu_off_default_edit_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_edit_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_backup_notify" '.(isset($_REQUEST['eu_off_default_backup_notify']) || empty($globals['eu_off_default_backup_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_backup_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_restore_notify" '.(isset($_REQUEST['eu_off_default_restore_notify']) || empty($globals['eu_off_default_restore_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_restore_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_clone_notify" '.(isset($_REQUEST['eu_off_default_clone_notify']) || empty($globals['eu_off_default_clone_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_clone_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_staging_notify" '.(isset($_REQUEST['eu_off_default_staging_notify']) || empty($globals['eu_off_default_staging_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_staging_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_import_notify" '.(isset($_REQUEST['eu_off_default_import_notify']) || empty($globals['eu_off_default_import_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_import_notify'].'</span><br />
			<input type="checkbox" name="eu_off_default_update_notify" '.(isset($_REQUEST['eu_off_default_update_notify']) || empty($globals['eu_off_default_update_notify']) ? 'checked="checked"' : '').' /><span class="sai_head">&nbsp;'.$l['eu_off_default_update_notify'].'</span><br />
			<input type="checkbox" name="eu_default_plainpass_notify" '.POSTchecked('eu_default_plainpass_notify', @$globals['eu_default_plainpass_notify']).' /><span class="sai_head">&nbsp;'.$l['eu_default_plainpass_notify'].'</span><br />
		</div>
	</div><br />
	...
	<div class="sai_form">
		<div class="row">
			<div class="col-sm-7">
				<label class="sai_head">'.$l['disable_wordpress_manager'].'</label><br />
				<span class="sai_exp2">'.$l['disable_wordpress_manager_exp'].'</span>
			</div>
			<div class="col-sm-5">
				<input type="checkbox" name="disable_wordpress_manager" '.POSTchecked('disable_wordpress_manager', @$globals['disable_wordpress_manager']).' />
			</div>
		</div><br />
...
if(!defined('SOFTRESELLER')){
	...
	<div class="sai_form">
		<div class="row">
			<div class="col-sm-7">
				<label class="sai_head">'.$l['preselect_autoupgrade_plugins'].'</label><br />
				<span class="sai_exp2">'.$l['preselect_autoupgrade_plugins_exp'].'</span>
			</div>
			<div class="col-sm-5">
				<input type="checkbox" name="preselect_autoupgrade_plugins" '.POSTchecked('preselect_autoupgrade_plugins', @$globals['preselect_autoupgrade_plugins']).' />
			</div>
		</div><br />
		
		<div class="row">
			<div class="col-sm-7">
				<label class="sai_head">'.$l['preselect_autoupgrade_themes'].'</label><br />
				<span class="sai_exp2">'.$l['preselect_autoupgrade_themes_exp'].'</span>
			</div>
			<div class="col-sm-5">
				<input type="checkbox" name="preselect_autoupgrade_themes" '.POSTchecked('preselect_autoupgrade_themes', @$globals['preselect_autoupgrade_themes']).' />
			</div>
		</div><br />
