			...
			<div class="col-sm-12 col-xs-12" id="main_div_serverUtilities">
				<div class="panel panel-default" id="main_table_serverUtilities">
					...
					<div class="panel-body pad0">
						...
						if(register_wordpress_manager()){
						echo'
						<a href="'.$globals['ind'].'act=wordpress">
							<div class="col-sm-2 col-xs-6 pan-button" id="webuzo_icons107" value="'.(empty($globals['wp_manager_cname']) ? $l['wp_manage_webuzo'] : $globals['wp_manager_cname']).'">
								<img src="'.$theme['a_images'].'wp.png" alt="" width="36" /><br>
								<span class="medium" >'.(empty($globals['wp_manager_cname']) ? $l['wp_manage_webuzo'] : $globals['wp_manager_cname']).'</span>
							</div>
						</a>';
						}
						echo'
