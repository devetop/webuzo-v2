		...
		<form accept-charset="'.$globals['charset'].'"  name="importsoftware" method="post" action="" onsubmit="return checkform();" role="form" class="form-horizontal">
			<script language="javascript" type="text/javascript"><!-- // --><![CDATA[
				...
				function suggestdompath(domval){
					...
					$_("domainpath").value = "public_html/"+$_("domain").value.trim();
				}
						...
						$.ajax({
							...
							success: function(data){
									...
									if(result == "1"){
										...
										$_("ip").value="";
										if($_("isaddon").checked == true){
											$_("domainpath").value="public_html/";
										}
			...
			<div class="row" id="addon" style="display:none;">
				...
				<div class="col-sm-7">
					<div class="input-group">
						...
						<input type="text" id="domainpath" name="domainpath" class="form-control" value="'.stripslashes(POSTval('domainpath', 'public_html/')).'" onfocus=""/>
					</div>
					<script language="javascript" type="text/javascript"><!-- // --><![CDATA[
