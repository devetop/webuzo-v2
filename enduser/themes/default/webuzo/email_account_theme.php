...
function email_account_theme(){
	...
	global $user, $globals, $l, $theme, $softpanel, $iscripts, $catwise, $error, $done, $domain_list, $email_list, $domain_name, $mail_settings, $is_running, $mailq;
	...
	$(document).ready(function(){	
			...
			try{
				...
				if(select_tab.length > 0){
					...
					$("#email_user_a").addClass("active");
					$("#email_user").addClass("in active");
				}
			}catch(e){}
			$( "#mailq_a" ).click(function() {
			  $("#email_user_a").removeClass("active");
				$("#email_user").removeClass("in active");				
				$("#mailq_a").addClass("active");
				$("#mailq").addClass("in active");
			});
	...
	if($softpanel->getacl('DISABLE_EMAIL') || $softpanel->getacl('DISABLE_EMAILADD')){
		...
		<div class="panel with-nav-tabs panel-default" id="panel-background" style="margin-bottom:0; border-bottom-style: none;border-width:0;"> 
			<div class="panel-heading" id="panel-heading-part" style="padding:0;background-color: #fff;">
				<ul class="nav nav-tabs no-border-bottom tab-center">
					<li align="center" id="email_user_a"><a href="#email_user" data-toggle="tab" class="heading_a" style="text-decoration:none"><label class="sai_sub_head">'.$l['record_table'].' <span id="domain_file">'.$domain_name.'</span></label></a></li>
					<li align="center" id="mailq_a"><a href="#mailq" data-toggle="tab" class="heading_a"  style="text-decoration:none"><label class="sai_sub_head"> <span id="domain_file">'.$l['mail_q'].'</span></label></a></li>					
				</ul>
			</div>
		</div>
		<div class="panel-body" id="panel-body-part">
			<div class="tab-content" style="height: auto;">
				<div class="tab-pane fade" id="email_user">
					<div id="showrectab">';
					show_email_users();
					echo '</div>
				</div>
				<div class="tab-pane fade" id="mailq">
					<textarea class="form-control" id="showlog" readonly="readonly"; style="height:400px; width:100%; overflow:auto; resize: none;" wrap="off"; >';r_print($mailq);echo '</textarea>
				</div>
			</div>			
		</div>';
	}
