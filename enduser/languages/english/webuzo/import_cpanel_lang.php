...
$l['note'] = '<b>Note:</b> This utility will import your data from cPanel. <a href="http://www.webuzo.com/wiki/Import_From_cPanel" target="_blank" >Here</a> is the guide for the same.<br><b style="color:red">This will overwite your all existing data.<b>';
