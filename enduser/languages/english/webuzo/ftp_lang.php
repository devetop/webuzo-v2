...
$l['record_del_conf'] = 'Are you sure want to delete this FTP user ? <br /><input type="checkbox" name="ftp_home_del" id="ftp_home_del" />&nbsp;&nbsp;<b>Select the checkbox to delete the FTP home directory</b>';
