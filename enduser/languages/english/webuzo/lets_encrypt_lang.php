...
$l['act_bg'] = 'The process is running in the background, please refresh the page after a few minutes.';
...
$l['renew_failed_subject'] = 'Failed to renew Lets Encrypt certificate (&soft-1)';